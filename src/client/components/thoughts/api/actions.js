...
export function create(data) {
  return dispatch => axios.post(routesApi, queryBuilder({
    type: 'mutation', operation: 'thoughtCreate', data, fields: ['id']
  }));
}
...
export function remove(data) {
  return dispatch => axios.post(routesApi, queryBuilder({
    type: 'mutation', operation: 'thoughtRemove', data, fields: ['id']
  }));
}
